...
export default function JobListings() {
  ...
  // Static jobs that are always visible to all visitors
  const staticJobs = [
    {
      id: "posted-1",
      positionRequired: "Drivers",
      organizationName: "ANGELS HILL MONTESSORI Recruitment Limited",
      location: "Tamale",
      remuneration: "Very Attractive",
      contractType: "Full-time",
      submittedAt: new Date().toISOString(),
      jobDescription: "Our client in a logistic business seeks reliable Drivers to operate buses. Responsible for safe transportation of staff/clients.",
      contactPerson: "ANGELS HILL MONTESSORI",
      email: "hope.services@ymail.com",
      telephone: "+233 243 105 412",
    },
    {
      id: "posted-2",
      positionRequired: "Domestic Workers",
      organizationName: "ANGELS HILL MONTESSORI Recruitment Limited",
      location: "Tamale",
      remuneration: "Competitive",
      contractType: "Full-time",
      submittedAt: new Date().toISOString(),
      jobDescription: "Domestic workers needed to manage day-to-day activities in the home including cleaning, cooking, and childcare.",
      contactPerson: "ANGELS HILL MONTESSORI",
      email: "hope.services@ymail.com",
      telephone: "+233 243 105 412",
    },
    {
      id: "posted-3",
      positionRequired: "Teachers (Pre-school & Basic School)",
      organizationName: "ANGELS HILL MONTESSORI Recruitment Limited",
      location: "Kalpohini Yapalsi - Tamale",
      remuneration: "Competitive",
      contractType: "Full-time",
      submittedAt: new Date().toISOString(),
      jobDescription: "Openings for Pre-school and Basic School Teachers in Tamale. Requires Diploma in Basic Education or SHS graduate.",
      contactPerson: "ANGELS HILL MONTESSORI",
      email: "hope.services@ymail.com",
      telephone: "+233 243 105 412",
    },
    {
      id: "posted-4",
      positionRequired: "Accounts Officers",
      organizationName: "ANGELS HILL MONTESSORI Recruitment Limited",
      location: "Tamale",
      remuneration: "GHS 5,500",
      contractType: "Full-time",
      submittedAt: new Date().toISOString(),
      jobDescription: "The Finance Officer will manage daily financial operations, maintain accurate bookkeeping, process transactions, and support basic financial reporting.",
      contactPerson: "ANGELS HILL MONTESSORI",
      email: "hope.services@ymail.com",
      telephone: "+233 243 105 412",
    },
    {
      id: "posted-5",
      positionRequired: "Personal Assistant",
      organizationName: "ANGELS HILL MONTESSORI Recruitment Limited",
      location: "Tamale",
      remuneration: "Competitive",
      contractType: "Full-time",
      submittedAt: new Date().toISOString(),
      jobDescription: "Professional Personal Assistant needed to provide high-level administrative support and manage daily schedules.",
      contactPerson: "ANGELS HILL MONTESSORI",
      email: "hope.services@ymail.com",
      telephone: "+233 243 105 412",
    },
  ...
  const loadJobPostings = () => {
    ...
    // Combine static jobs with both sources, ensuring all jobs appear first
    // Both sources use 'submittedAt' for timestamp
    const combinedPostings = [...staticJobs, ...adminPostings, ...employerPostings].sort((a, b) => {
